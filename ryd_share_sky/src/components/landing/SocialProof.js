...
class SocialProof extends Component {
	render() {
		...
		return (
			<div>
				<section id="social-proof" className="section is-medium section-secondary">
            <div className="container">
		        ...
		        <section className="section section-feature-grey is-medium" style={{ paddingBottom: '0' }}>
		            <div className="container">
		                <div className="columns">
		                    <div className="column is-10">
		                        <div className="has-text-centered">
															<figure className="image is-4by3" style={{ marginBottom: '-10em', marginTop: '5em' }}>
						                  	<img className="pushed-image" src={appMock} alt="Product preview" style={{width: '50em', height: '40em', borderRadius: "8px"}}/>
															</figure>
		                        </div>
		                    </div>
